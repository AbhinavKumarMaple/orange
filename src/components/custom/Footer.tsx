...
export default function Footer({ socialLinks = [] }: FooterProps) {
    ...
    return (
        <footer data-section="Footer" style={{ backgroundColor: colors.footer }} className="px-5 sm:px-8 pt-16 sm:pt-20 pb-6">
            <div className="w-full h-px mb-12 sm:mb-16" style={{ backgroundColor: "rgba(9,9,9,0.12)" }} />
            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-12 mb-12 sm:mb-16">
                ...
                <div className="max-w-md">
                    <h3
                        ...
                        style={{ color: colors.dark, fontSize: "clamp(48px, 7vw, 76px)", lineHeight: "1", letterSpacing: "-0.04em" }}
                    >
                        Stay in loop
                    </h3>
                    <p
                        className="font-sans mb-6"
                        style={{ color: "#6b6b6b", fontSize: 16, lineHeight: "20.8px", letterSpacing: "-0.48px" }}
                    >
                        Join our newsletter and stay updated on the latest trends in digital design.
                    </p>
                    <p className="font-sans font-medium mb-2" style={{ color: colors.dark, fontSize: 16 }}>
                        Email
                    </p>
                    <div className="flex items-center gap-3">
                        <input
                            ...
                            className="bg-white rounded px-4 py-3 font-sans outline-none flex-1 min-w-0 border border-black/10"
                            style={{ fontSize: 16, color: colors.dark }}
                        />
                        <button
                            className="flex items-center justify-center rounded shrink-0 cursor-pointer"
                            style={{ backgroundColor: colors.accent, width: 44, height: 44 }}
                            aria-label="Subscribe"
                            data-track-click="footer_newsletter_subscribe"
                        >
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3 13L13 3M13 3H5M13 3V11" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        </button>
                    </div>
                </div>
                ...
                <div className="flex gap-12 sm:gap-20">
                    ...
                    {socialLinks.length > 0 && (
                        <div>
                            <p className="font-sans mb-4" style={{ color: "#6b6b6b", fontSize: 16 }}>Follow us</p>
                            <div className="flex flex-col gap-2">
                                {socialLinks.map((s) => (
                                    <Link
                                        key={s.id}
            ...
            <div className="overflow-hidden mb-8 -mx-5 sm:-mx-8">
                <h2
                    ...
                    style={{ color: colors.dark, fontSize: "14vw", lineHeight: 1.02, letterSpacing: "-0.05em" }}
                >
                    Orange Studios
                </h2>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <p className="font-sans" style={{ color: "#6b6b6b", fontSize: 14 }}>
                    © 2026 Orange Studios. All rights reserved.
                </p>
                <div className="flex items-center gap-6 sm:gap-12">
                    <Link href="#" className="font-sans" style={{ color: "#6b6b6b", fontSize: 14 }}>
                        Privacy policy
                    </Link>
                    <Link href="#" className="font-sans" style={{ color: "#6b6b6b", fontSize: 14 }}>
                        Terms of Service
